...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php base_url('assets/template/back') ?>/plugins/iCheck/square/blue.css">
  ...
  <div class="login-box-body">
    ...
    <?php echo form_open('login/proses_login'); ?>
      <div class="form-group has-feedback">
        <input type="name" name="username" class="form-control" placeholder="Email">
